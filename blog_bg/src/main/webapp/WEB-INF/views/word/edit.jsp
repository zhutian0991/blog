      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<ol class="breadcrumb">
				  ...
				  <li><a href="${APP_PATH}/word/list.htm">碎言碎语列表</a></li>
				  <li class="active">碎言碎语</li>
				</ol>
			<div class="panel panel-default">
              <div class="panel-heading">碎言碎语<div style="float:right;cursor:pointer;"></div></div>
			  <div class="panel-body">
				<form role="form" id="formBtn" >
				  <div class="form-group">
				  	<textarea class="form-control" rows="5" cols="40" name="content" style="width: 500px;" id="fcontent" placeholder="请输入说说内容">${word.content}</textarea>
	...
	<script src="${APP_PATH}/script/docs.min.js"></script>
        <script type="text/javascript">
            ...
            $("#formSubmit").click(function(){
            	...
            	if(content==""){
            		layer.msg("说说内容不能为空", {time:1000, icon:5, shift:6},function(){
            			$("#fcontent").focus();
            		});
            		return;
            	}
            	...
            	var dataObj={};
            	if(id==""){
            		url = "${APP_PATH}/word/insert.do";
            		dataObj={"content":content};
            	}else{
            		url = "${APP_PATH}/word/update.do";
            		dataObj={"id":id,"content":content};
            	}
            	$.ajax({
            		url:url,
            		type:"post",
            		...
            		success:function(result){
            			if(result.insert){
            				layer.msg("添加说说成功！", {time:1000, icon:6},function(){
            					window.location.href="${APP_PATH}/word/list.htm";
            				});
            			}
            			
            			if(result.update){
            				layer.msg("修改说说成功！", {time:1000, icon:6},function(){
            					window.location.href="${APP_PATH}/word/list.htm";
            				});
            			}
            		}
