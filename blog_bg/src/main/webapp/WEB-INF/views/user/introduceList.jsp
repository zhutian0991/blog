      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<ol class="breadcrumb">
				  ...
				  <li><a href="${APP_PATH}/own/list.htm">个人简介</a></li>
				  <li class="active">查看</li>
				</ol>
			<div class="panel panel-default">
              <div class="panel-heading">个人简介<div style="float:right;cursor:pointer;"></div></div>
			  <div class="panel-body">
			  	<c:if test="${empty suser.introduce}">
			  		<button type="button" class="btn btn-primary" style="float:left;" onclick="window.location.href='${APP_PATH}/user/introduceEdit.htm'"><i class="glyphicon glyphicon-plus"></i>新增</button>
			  	</c:if>
			  	<c:if test="${not empty suser.introduce}">
			  		<button type="button" class="btn btn-primary" style="float:left;" onclick="window.location.href='${APP_PATH}/user/introduceEdit.htm'"><i class="glyphicon glyphicon-pencil"></i>修改</button>
			  	</c:if>
			  	<hr style="clear:both;">
				<p>${suser.introduce}</p>
			  </div>
