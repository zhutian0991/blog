      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="panel panel-default">
			  ...
			  <button type="button" class="btn btn-primary" style="float:left;" onclick="window.location.href='${APP_PATH}/home/edit.htm'"><i class="glyphicon glyphicon-plus"></i> 新增</button>
			  <br>
 			  <hr style="clear:both;">
              ...
              <tbody>
				<c:forEach items="${links}" var="link" varStatus="status">
					<tr>
						...
						<td>${link.url}</td>
						<td>
							<button type="button" onclick="window.location.href='${APP_PATH}/home/edit.htm?id=${link.id}'" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></button>
							<button type="button" onclick="deleteLink(${link.id},'${link.name}')" class="btn btn-danger btn-xs"><i class=" glyphicon glyphicon-remove"></i></button>
						</td>
					</tr>
				</c:forEach>
              </tbody>
        ...
        <script type="text/javascript">
		    ...
		    function deleteLink(id,name){
            	layer.confirm("确定要删除["+name+"]嘛？",  {icon: 3, title:'提示'}, function(cindex){
            		$.ajax({
            			url:"${APP_PATH}/home/delete.do",
            			type:"post",
            			data:{"id":id},
            			success:function(result){
            				if(result.success){
            					layer.msg("链接删除成功！", {time:1000, icon:6},function(){
