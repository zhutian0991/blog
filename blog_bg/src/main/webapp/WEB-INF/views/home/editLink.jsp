      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<ol class="breadcrumb">
				  ...
				  <li><a href="${APP_PATH}/home/link.htm">链接列表</a></li>
				  <li class="active">友情链接</li>
				</ol>
			<div class="panel panel-default">
              <div class="panel-heading">友情链接<div style="float:right;cursor:pointer;"></div></div>
			  <div class="panel-body">
				<form role="form" id="formBtn" >
				  <div class="form-group">
					<input style="width: 400px;" type="text" value="${link.name}" class="form-control" id="fname" placeholder="请输入链接名称">
					<input type="hidden" id="fid" name="id" value="${param.id}" >
				  </div>
				  <div class="form-group">
					<input style="width: 400px;" type="text" value="${link.url}" class="form-control" id="furl" placeholder="请输入链接地址">
				  </div>
	...
	<script src="${APP_PATH}/script/docs.min.js"></script>
        <script type="text/javascript">
            ...
            $("#formSubmit").click(function(){
            	...
            	name = $.trim(name);
            	if(name==""){
            		layer.msg("链接名称不能为空", {time:1000, icon:5, shift:6},function(){
            			$("#fname").focus();
            		});
            		return;
            	}
            	...
            	var dataObj={};
            	if(id==""){
            		url = "${APP_PATH}/home/insert.do";
            		dataObj={"name":name,"url":furl};
            	}else{
            		url = "${APP_PATH}/home/update.do";
            		dataObj={"id":id,"name":name,"url":furl};
            	}
            	$.ajax({
            		url:url,
            		type:"post",
            		...
            		success:function(result){
            			if(result.insert){
            				layer.msg("添加链接成功！", {time:1000, icon:6},function(){
            					window.location.href="${APP_PATH}/home/link.htm";
            				});
            			}
            			
            			if(result.update){
            				layer.msg("修改链接成功！", {time:1000, icon:6},function(){
            					window.location.href="${APP_PATH}/home/link.htm";
            				});
            			}
            		}
